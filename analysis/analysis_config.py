...
class Config:
    ...
    PHOTO_COUNTS = 12  # Количество данных для создания модели (для 1 просто призма контура. >1 если бы переход к 3D работал стабильно, улучшало бы качество 3D модели)
